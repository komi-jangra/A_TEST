...
**      ----               ----            ---------        ------
**     22/07/02            Suyash Tripathi             SPR 9302 - Warning Removal
**     22/04/02            Sachin Bhatia               Corrected ss7_bcopy prototype 
**								- SPR 7550
**
**     22/12/99            Rahul Gupta                 Added prototype for
**                                                     ss7_memcpy.
**
**      30/10/99           Rafi Assadi H.M.            Added prototype for ss7_rand 
**
**	04Apr'98	   P. Srivastava		Added Prototype More prototypes.
**
**	03Apr'98	   Praneet K.			   Removing nested refs.
**								&
**							   putting ANSI_PROTOs
**      28/01/98           Sunil M.            -      	    Initial
**     Pmishra
**
**
**
...
#ifdef ANSI_PROTO
	(U32bit,pvoid,s7_len_t,module_id_t,timer_id_t*,error_t*);
#else
	();
#endif
...
ss7_redn_build_api
	...
	();
#endif
/* Added by Amaresh sccp_redn_options_t as on dated 11-03-16*/
#if 0
extern return_t
ss7_send_update
    (module_id_t    module_id,
