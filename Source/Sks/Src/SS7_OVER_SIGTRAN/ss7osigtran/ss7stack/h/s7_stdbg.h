/***************************************************************************
**  FUNCTION:
**      common file for some trace related definitions for SCCP & TCAP.
**
****************************************************************************
**
**  FILE NAME:
...
**              to be used by SCCP & TCAP.
**
**      DATE     NAME              REF#    REASON
**      -------  ----------------  -----   --------------------------------
**      15Jan98  gtaneja           -----   Original  
**		18Aug98	 P. Khare		   -----   SCOC_TRACE added
**	29Jan 2002 Pawanish			changes for DTCAP
**
...
#ifdef SCCP
extern U32bit sccp_trace_table[];
/* 
#define TRACE_TABLE sccp_trace_table
*/
#endif
