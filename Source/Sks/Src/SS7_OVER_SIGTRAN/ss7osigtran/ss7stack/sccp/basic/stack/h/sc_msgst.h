...
typedef struct
{
	Boolean f_bit;
	/** SPR # 2663 Fix Start **/
	Boolean isdo; /* in-seq delivery option */
	/** SPR # 2663 Fix End **/
	/* SPR 10882 - Fix Start */
	U8bit spare_bit;
	/* SPR 10882 - Fix End  */
...
/* SPR 8985 - Fix Start */
/* #define IS_IMPORTANCE_PRESENT(p)	     (IE_FLAG(p) & IMPORTANCE_MASK)*/
/* #define IS_IMPORTANCE_IE_PRESENT(p)	     (IE_FLAG(p) & IMPORTANCE_MASK)*/
...
/* SPR 8985 - Fix Start */
/* #define SET_IMPORTANCE_PRESENT(p)        (IE_FLAG(p) |= IMPORTANCE_MASK)*/
...
/* SPR 8985 - Fix Start */
/* #define CLR_IMPORTANCE_PRESENT(p)      (IE_FLAG(p) &= ~IMPORTANCE_MASK)*/
...
typedef struct
{
	U8bit * p_api; /* Pointer to the API which contains the message */
	...
	/* params exclusive to communication to upper layer */
	U8bit seq_param;
	...
	/* SCCP msg parameters */
	sccp_addr_t cd_addr;   /* Called party address */
	sccp_addr_t cg_addr;   /* Calling party address */
	U8bit       proto_class; /* Protocol class */
	U8bit       ret_cause; /* Return cause */
	data_t      data;      /* data */
	segm_t      segment;   /* Segmentation */
	/** SPR # 3643 Fix: Changed type of hop_couter from S8bit to U8bit 
	**/
	U8bit       hop_counter;  /* Hop counter */
	U8bit       importance;   /* Importance */
#if defined (SCCP_ANSI) || defined (SCCP_BCGR)
    isni_t      isni;      /* ISNI */
#endif

#ifdef SCCP_INCLUDE_CO_SERVICE
    /* Connection oriented service parameters */
    sccp_ccb_t *p_ccb;
    U8bit     event ;
    U32bit    slr ;
    U32bit    dlr ;
	...
	/* SPR # 2579 Fix Start */
	/* This flag is used to mark that routing failure has been handled and any
	** subsequent routing failures of the messages initiated by route-failure
	** handler will be ignored 
	*/
	Boolean   route_failure_flag; 
	/* SPR # 2579 Fix Start */
	

    sccp_addr_t trans_addr;

    sp_entry_t * p_sp;
    ss_entry_t * p_ss;
#ifdef DISTRIBUTED_SCCP
	Boolean dsccp_mate_api;
#endif
    U8bit   received_rout_ind;

} msg_info_t;

#ifdef DISTRIBUTED_SCCP
typedef struct dsccp_class1_buff_node {
		U8bit *p_api;
		struct dsccp_class1_buff_node * next_node;
		}dsccp_class1_buff_node;
#endif
...
/* Note : MIN_MSG_LEN below include length of fix parameters and number
   ...
   Total : 7 bytes
*/
/* spr #8530 - increased min msg length by 1 */
/* SPR IMP_SPR : Fix - Reverting SPR 8530 Change */
...
/* #define IDX_OPT_PARAM_PTR_IN_UDT   5 */	/* SPR IMP_SPR : Obsolete #define */
/* salil - spr 8530 ends */
...
/* salil - spr 8530 starts */
/* #define IDX_OPT_PARAM_PTR_IN_UDTS  5 */  /* SPR IMP_SPR : Obsolete #define */
/* salil - spr 8530 ends */
...
/* # define IDX_OPT_PARAM_PTR_IN_RLC   7  */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */

/* spr #8530 - increased min msg length by 2 */
/* SPR IMP_SPR : Fix - Reverting SPR 8530 Change */
#define MIN_DT1_MSG_LEN             6
#define NUM_MAND_VAR_IES_IN_DT1     1
#define IDX_DATA_PTR_IN_DT1         5
/* spr #8530 starts */
/* # define IDX_OPT_PARAM_PTR_IN_DT1   6 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */
...
/* spr #8530 starts */
/* # define IDX_OPT_PARAM_PTR_IN_DT2   7 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */
...
/* # define IDX_OPT_PARAM_PTR_IN_AK    6 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */
...
/* spr #8530 starts */
/* # define IDX_OPT_PARAM_PTR_IN_ED    5 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */
...
/* # define IDX_OPT_PARAM_PTR_IN_EA    4 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */

/* SPR 1768: changed RSR msg length to 8 */
/* spr #8530 - increased min msg length by 1 */
/* SPR IMP_SPR : Fix - Reverting SPR 8530 Change */
/* SPR 11060 - Fix */
...
/* #define IDX_OPT_PARAM_PTR_IN_RSC    7  */  /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */

/* SPR 1502: Changed value for ITU-T */
/* spr #8530 - increased min msg length by 1 */
/* SPR IMP_SPR : Fix - Reverting SPR 8530 Change */
/* SPR 11060 - Fix */
...
/* # define IDX_OPT_PARAM_PTR_IN_IT    11 */ /* SPR IMP_SPR : Obsolete #define */
/* spr #8530 ends */
...
/** SPR # 2618 Fix Start **/
/* This value is not defined in ANSI & GR; it is a spare value;
** SCCP_ERR_IN_LOCAL_PROCESSING is being used in its place
*/
