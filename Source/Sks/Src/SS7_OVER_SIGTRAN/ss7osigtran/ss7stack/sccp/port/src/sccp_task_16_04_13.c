...
extern int source_point_code,destination_point_code;
...
void sccp_read_cfg()
{
  /* unsigned char input1[10]="19612242";	
   ...
   unsigned char input1[10]="91162224";
   unsigned char input2[10]="91222234";
   unsigned char output1[10]="91987654";
   unsigned char output2[10]="91981234";
   ...
   C.sccp_params.max_sp = 64;
   C.sccp_params.max_ss = 32;  
   C.sccp_params.max_css = 64;
   C.sccp_params.max_csp = 64;  
   ...
   C.sccp_params.seg_parm_z = 160;
	...
	sccp_sp_data_list[0].sp_id = 1;
        sccp_sp_data_list[0].nw_id = 0;
        sccp_sp_data_list[0].ssf = 0x00;
        sccp_sp_data_list[0].valid = 1;
        sccp_sp_data_list[0].local = 1;
				sccp_sp_data_list[0].pc = source_point_code; /*1;	*/
/* Multiple SSN configuration */
			
				sccp_sp_data_list[0].ssn_data[0].valid = 1;
        sccp_sp_data_list[0].ssn_data[0].ss_id = 1;
        sccp_sp_data_list[0].ssn_data[0].ssn = 6;	

				sccp_sp_data_list[0].ssn_data[1].valid = 1;
        sccp_sp_data_list[0].ssn_data[1].ss_id = 2;
        sccp_sp_data_list[0].ssn_data[1].ssn = 7;
	
				sccp_sp_data_list[0].ssn_data[2].valid = 1;
        sccp_sp_data_list[0].ssn_data[2].ss_id = 3;
        sccp_sp_data_list[0].ssn_data[2].ssn = 8;
				
				sccp_sp_data_list[0].ssn_data[3].valid = 1;
        sccp_sp_data_list[0].ssn_data[3].ss_id = 4;
        sccp_sp_data_list[0].ssn_data[3].ssn = 9;

				sccp_sp_data_list[0].ssn_data[4].valid = 1;
        sccp_sp_data_list[0].ssn_data[4].ss_id = 5;
        sccp_sp_data_list[0].ssn_data[4].ssn = 0xf1;

				sccp_sp_data_list[0].ssn_data[5].valid = 1;
        sccp_sp_data_list[0].ssn_data[5].ss_id = 6;
        sccp_sp_data_list[0].ssn_data[5].ssn = 0xf2;
        ...
        sccp_sp_data_list[1].local = 0;
				sccp_sp_data_list[1].pc = destination_point_code; /*2;	*/
/* Multiple SSN configuration */
			
				sccp_sp_data_list[1].ssn_data[0].valid = 1;
        sccp_sp_data_list[1].ssn_data[0].ss_id = 7;
        sccp_sp_data_list[1].ssn_data[0].ssn = 6;

				sccp_sp_data_list[1].ssn_data[1].valid = 1;
        sccp_sp_data_list[1].ssn_data[1].ss_id = 8;
        sccp_sp_data_list[1].ssn_data[1].ssn = 7;
	
        sccp_sp_data_list[1].ssn_data[2].valid = 1;
        sccp_sp_data_list[1].ssn_data[2].ss_id = 9;
        sccp_sp_data_list[1].ssn_data[2].ssn = 8;
        
				sccp_sp_data_list[1].ssn_data[3].valid = 1;
        sccp_sp_data_list[1].ssn_data[3].ss_id = 10;
        sccp_sp_data_list[1].ssn_data[3].ssn = 9;

				sccp_sp_data_list[1].ssn_data[4].valid = 1;
        sccp_sp_data_list[1].ssn_data[4].ss_id = 11;
        sccp_sp_data_list[1].ssn_data[4].ssn = 0xf1;

				sccp_sp_data_list[1].ssn_data[5].valid = 1;
        sccp_sp_data_list[1].ssn_data[5].ss_id = 12;
        sccp_sp_data_list[1].ssn_data[5].ssn = 0xf2;
	...
	gsn_gtt_table[1].ssn = 0;/* 16-04-13 Amaresh set 0 for outgoing ssn*/ 
...
!= SS7_SUCCESS)
  ...
  for (i = 0;sccp_sp_data_list[i].valid && i < 2;i++)
  {
	...
	{
            printf("SCCP_INIT: ADDED  SP Sucessfully [%d] with point code  [%d] SUCCESSFULLY \n", sp_conf_info.sp_id,sp_conf_info.pc);
	    	
	}
   }	
   for (j = 0,i = 0 ; sccp_sp_data_list[i].ssn_data[j].valid && j < SIGTRAN_MAX_SSN_PER_PC; j++)
   {
           printf("SCCP_INIT: Adding signalling SS for (SP-ID=[%d])... (SS-ID=[%d])...\n", sccp_sp_data_list[i].sp_id,sccp_sp_data_list[i].ssn_data[j].ss_id);
	  ...
	  {
           	printf("Add SS for SP-ID [%d],SS-ID[%d] SUCCESSFULLY \n",ss_conf_info.sp_id, ss_conf_info.ss_id);
          }
   }
   for (j = 0,i = 1 ; sccp_sp_data_list[i].ssn_data[j].valid && j < SIGTRAN_MAX_SSN_PER_PC; j++)
   {
           printf("SCCP_INIT: Adding signalling SS for (SP-ID=[%d])... (SS-ID=[%d])...\n", sccp_sp_data_list[i].sp_id,sccp_sp_data_list[i].ssn_data[j].ss_id);
           ss_conf_info.ss_id = sccp_sp_data_list[i].ssn_data[j].ss_id;
           ss_conf_info.sp_id = sccp_sp_data_list[i].sp_id;
   ...
   for (j = 0,i = 1 ; sccp_sp_data_list[i].ssn_data[j].valid && j < SIGTRAN_MAX_SSN_PER_PC; j++)
   {
		    ...
		    {				 
                        printf("SCCP_INIT: added CSS for SS-ID SUCCESSFULLY [%d] \n", sccp_sp_data_list[i].ssn_data[j].ss_id);
                    } 
   }
   ...
   for (j = 0,i = 1 ; sccp_sp_data_list[i].ssn_data[j].valid && j < SIGTRAN_MAX_SSN_PER_PC; j++)
   {
		    ...
		    {				 
                        printf("SCCP_INIT: added CSS SUCCESSFULLY SS-ID [%d] \n", sccp_sp_data_list[i].ssn_data[j].ss_id);
                    } 
   }
   ...
   for (j = 0,i = 0 ; sccp_sp_data_list[i].ssn_data[j].valid && j < SIGTRAN_MAX_SSN_PER_PC; j++)
   {
          ...
          p_csp_info.csp_id = sccp_sp_data_list[1].sp_id;
	 ...
	 {
           printf("SCCP_INIT: Added CSP SUCCESSFULLY for SS-ID [%d] \n", sp_conf_info.sp_id);
	 }
                            /* exit (1);*/
   }
