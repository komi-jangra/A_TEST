...
ifeq ($(ARCH), ARM)
    ...
    LD = $(VNL_COM_PREFIX)ld
    RANLIB = $(VNL_COM_PREFIX)ranlib
    STRIP = strip
    SAFELIB=-lsocket -lnsl
    COMMONLIB=-lposix4 -lsocket -lnsl
		LDFLAGS = -L /home/CodeSourcery/Sourcery_CodeBench_Lite_for_ARM_GNU_Linux/bin/arm-none-linux-gnueabi-ld 
endif
endif
ARFLAGS = rv
...
CPPFLAGS = \
	...
	-I$(ccm_project_path)/BsStk/bssap/h \
	-I../h \
  -I$(BPM_INC) \
  -I$(BPM_INC)/../Ipc \
  -I$(BPM_INC)/../Sys \
