/*****************************************************************************
 ...
 @(#) $RCSfile: xti_xti.h,v $ $Name: not supported by cvs2svn $($Revision: 1.1.1.1 $) $Date: 2007-10-08 11:11:34 $
...
#ident "@(#) $RCSfile: xti_xti.h,v $ $Name: not supported by cvs2svn $($Revision: 1.1.1.1 $) Copyright (c) 2001-2004 OpenSS7 Corporation."
