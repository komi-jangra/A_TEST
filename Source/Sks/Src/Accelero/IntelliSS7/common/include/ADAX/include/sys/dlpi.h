 ...
 * Last Modified By: $Author: bsccs2 $
 * Last Modified On: $Date: 2007-10-08 11:11:33 $
 * Update Count    : $Revision: 1.1.1.1 $
 * RCS Id          : $Id: dlpi.h,v 1.1.1.1 2007-10-08 11:11:33 bsccs2 Exp $
 * Status          : ($State: Exp $) 
...
# if defined(_LP64)			/* 64-bit compile */
