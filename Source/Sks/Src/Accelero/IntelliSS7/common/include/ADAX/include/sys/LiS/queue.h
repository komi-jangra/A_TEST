 ...
 * RCS Id          : $Id: queue.h,v 1.1.1.1 2007-10-08 11:11:34 bsccs2 Exp $
...
#ident "@(#) LiS queue.h 2.31 09/13/04 10:13:51 "
...
#else
#define	LIS_CHECK_Q_MAGIC(q)	((q))
#define LIS_QMAGIC(q,f,l)	((q))
#endif
