 ...
 * LOG: Revision 1.2  2007/12/05 04:30:51  bsccs2
 * LOG: *** empty log message ***
 * LOG:
 * LOG: Revision 1.1.1.1  2007/10/08 11:11:56  bsccs2
 * LOG: Init Code
 * LOG:
 ...
 * LOG: BscCs2
 * LOG:
 * LOG: Revision 1.3  2007/05/23 08:42:34  cvsadmin
 * LOG: *** empty log message ***
 * LOG:
 * LOG: Revision 1.2  2007/03/30 04:58:47  cvsadmin
 * LOG: *** empty log message ***
 * LOG:
...
#ident "$Id: its_alarm.c,v 1.3 2007-12-29 06:59:20 bsccs2 Exp $"
 ...
 *  See Also:
 ****************************************************************************/
extern  ITS_USHORT SCM_instance; 
           ...
           ITS_SUCCESS)
    {
        ...
        default:
         ...
         /*   CALLBACK_CallCallbackList(ALARM_Callbacks,
            ...
            if(SCM_instance !=NULL)
             {
                 alarmEvent.src=99;   
	         res = TRANSPORT_PutEvent(SCM_instance, &alarmEvent);
		 if(res!=ITS_SUCCESS)
                 {
                      ITS_TRACE_DEBUG(("No Reporting of Alarm due to connection faliure\n"));
                      ITS_EVENT_TERM(&alarmEvent);
                 }
