 ...
 * LOG: BscCs2
 * LOG:
 * LOG: Revision 1.2  2007/03/30 04:59:06  cvsadmin
 * LOG: *** empty log message ***
 * LOG:
 * LOG: Revision 1.1.1.1  2006/12/22 13:34:45  cvsadmin
 * LOG: Initialising sources in CVS
 * LOG:
 * LOG: Revision 9.1.8.2  2005/12/21 10:00:24  sjaddu
 * LOG: Compilation problem fixed.
 * LOG:
 * LOG: Revision 9.1.8.1  2005/11/30 11:31:13  sjaddu
 * LOG: Added MEMPOOL_CreateLockHeapPool definition.
 * LOG:
...
#ident "$Id: its_mem_pool.c,v 1.1.1.1 2007-10-08 11:11:57 bsccs2 Exp $"
...
#undef MEMPOOL_CreateLockHeapPool
 ...
 *  Return Value:
 *
 *  Notes: definition is added.
 *
 *  See Also:
 ****************************************************************************/
ITSDLLAPI MEMPOOL_Manager *
MEMPOOL_CreateLockHeapPool(ITS_UINT powers)
{
    return (MEMPOOL_Manager *)ITS_ConstructObject(itsLOCKHEAPPOOL_Class,
                                                  powers, NULL);
}
