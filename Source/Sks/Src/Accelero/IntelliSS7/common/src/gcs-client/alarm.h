...
/* HLD: changed DEBUG to TR_DEBUG (all other files too). */
#define         TR_DEBUG        0x00000001
/* HLD: end. */
...
/* HLD: changed STATUS to ALARM_STATUS (all other files too). */
#define         ALARM_STATUS    0x00000800
/* HLD: end. */
