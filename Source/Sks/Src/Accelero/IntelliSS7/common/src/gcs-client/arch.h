...
/* HLD: added for compatibility with Sun Solaris native C compiler (cc) . */
...
/* MLM: Note that you must specify -xtarget=ultra -xarch=v9 IN THAT ORDER */
#if __sparcv9
#define         INTSIZE64
