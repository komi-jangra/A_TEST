/* $Id: sisci_api.h,v 1.1.1.1 2007-10-08 11:11:52 bsccs2 Exp $  */
/*******************************************************************************
 *                                                                             *
...
/*********************************************************************************
 *                                                                               *
 * S C I   V E R I F Y  A P I  V E R S I O N                                     *
 *                                                                               *
 * Verifies that the SISCI application binary is compliant with the linked       * 
 * SISCI library.                                                                *
 *                                                                               *
 *  Flags                                                                        *
 *  None                                                                         *
 ...
 *  Specific error codes for this function:                                      *
 *                                                                               *
 *  SCI_ERR_INCONSISTENT_VERSIONS    - Inconsistency between the SISCI API       *
 *                                     and the versions. API_VER_MINOR or        *
 *                                     API_VER_MAJOR is different.               *
 *                                                                               *
 * *curApiVersion will always be set to point to the value SISCI_API_VERSION     *
 *                                                                               *
 *                                                                               *
 *********************************************************************************/
#define SCIVerifyAPIVersion                 _SISCI_EXPANDE_FUNCTION_NAME(SCIVerifyAPIVersion)
DLL void SCIVerifyAPIVersion(unsigned    apiVersion,
                             unsigned    *currApiVersion,
                             unsigned    flags,
                             sci_error_t *error);
...
#define sciMemCopyFuncPtr                        _SISCI_EXPANDE_VARIABLE_NAME(sciMemCopyFuncPtr)

extern
DLL void (*sciMemCopyFuncPtr)(void         *memAddr,
                              sci_map_t     remoteMap,
                              unsigned int  remoteOffset,
                              unsigned int  size,
                              unsigned int  flags,
