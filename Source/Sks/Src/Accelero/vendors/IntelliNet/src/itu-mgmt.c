 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-mgmt.c,v 1.2 2008-01-14 05:32:52 bsccs2 Exp $
 *
 ...
 * LOG:
 * LOG: Revision 9.4.2.1  2006/07/04 12:12:00  gdevanand
...
#ident "$Id: itu-mgmt.c,v 1.2 2008-01-14 05:32:52 bsccs2 Exp $"
...
;
    ...
    /*for OAM requirement*/
    else if (DBC_Cmd(dbc, "mi_set_tmr", "Mtp3 Set Timer",
	                            "<tmr> <value>", "<Timer#> <value>"))
    {
     ...
     if (tr > 35)
     {
        ...
        return;
												           ...
												           TIMERS_SetTimerValue(&CCITT_MTP3_Timers, tr, value);
   }										       
  else if (DBC_Cmd(dbc, "mi_get_tmr", "MTP3 Get Timers",
	                       "", ""))
   {
    int value = 0;
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T1);
    sprintf(buf, "    MTP3_T1       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T2);
    sprintf(buf, "    MTP3_T2       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T3);
    sprintf(buf, "    MTP3_T3       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T4);
    sprintf(buf, "    MTP3_T4       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T5);
    sprintf(buf, "    MTP3_T5       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T6);
    sprintf(buf, "    MTP3_T6       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T7);
    sprintf(buf, "    MTP3_T7       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T8);
    sprintf(buf, "    MTP3_T8       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T8);
    sprintf(buf, "    MTP3_T9       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T10);
    sprintf(buf, "    MTP3_T10       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T11);
    sprintf(buf, "    MTP3_T11       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T12);
    sprintf(buf, "    MTP3_T12       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T13);
    sprintf(buf, "    MTP3_T13       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T14);
    sprintf(buf, "    MTP3_T14       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T15);
    sprintf(buf, "    MTP3_T15       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T16);
    sprintf(buf, "    MTP3_T16       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T17);
    sprintf(buf, "    MTP3_T17       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T18);
    sprintf(buf, "    MTP3_T18       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T19);
    sprintf(buf, "    MTP3_T19       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T20);
    sprintf(buf, "    MTP3_T20       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T21);
    sprintf(buf, "    MTP3_T21       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T22);
    sprintf(buf, "    MTP3_T22       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T23);
    sprintf(buf, "    MTP3_T23       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T24);
    sprintf(buf, "    MTP3_T24       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T25);
    sprintf(buf, "    MTP3_T25       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T26);
    sprintf(buf, "    MTP3_T26       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T27);
    sprintf(buf, "    MTP3_T27       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T28);
    sprintf(buf, "    MTP3_T28       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T29);
    sprintf(buf, "    MTP3_T29       <%d> \n", value);
    DBC_AppendText(dbc, buf);
    value = TIMERS_GetTimerValue(&CCITT_MTP3_Timers, MTP3_TIMER_T30);
    sprintf(buf, "    MTP3_T30       <%d> \n", value);
    DBC_AppendText(dbc, buf);
  }
...
MTP3_OSS_AddLinkset_CCITT(ITS_OCTET linkSet, SS7_Family family, ITS_UINT lpc, ITS_UINT apc, ITS_UINT ni)
{
    ...
    linkset.firstLink   = ITS_TRUE;   /* Magesh 28-Jun-06 */
 ...
 ****************************************************************************/
ITSSS7DLLAPI ITS_INT 
MTP3_OSS_AddRemotePC_CCITT(ITS_UINT rpc, ITS_OCTET ni, ITS_OCTET linkSet, SS7_Family family)
{
    ITS_INT         ret;
    SS7_LinkSetPtr  ls;
    SS7_LinkPtr     lp;
 ...
 ****************************************************************************/
ITSSS7DLLAPI ITS_INT 
MTP3_OSS_RemoveRemotePC_CCITT(ITS_UINT rpc, ITS_OCTET ni, ITS_OCTET linkSet, SS7_Family family)
{
    ITS_INT             ret;
    SS7_LinkSetPtr      ls;
    SS7_Destination     *rc;
