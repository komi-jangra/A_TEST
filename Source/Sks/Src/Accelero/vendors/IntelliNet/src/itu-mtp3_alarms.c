 ...
 ****************************************************************************
 *
 *  ID:$Id: itu-mtp3_alarms.c,v 1.1.1.1 2007/10/08 11:12:15 bsccs2 Exp $
 *
...
ALARM_FORMAT_SUBSYS(CCITT_MTP3, 2466,
                    ...
                    ALARM_LVL_MINOR,         "FindAlternateRoute",
                    "MTP3", ITS_TRUE);
...
ALARM_FORMAT_SUBSYS(CCITT_MTP3, 2800,
                    "Link Set Out of Service:",
                    ALARM_LVL_CRIT,         "LSAC_Main",
                    "Subsystem", ITS_FALSE);

ALARM_FORMAT_SUBSYS(CCITT_MTP3, 2801,
...
ALARM_Format *CCITT_MTP3_Alarms[] =
{
    ...
    NULL,
    NULL,
    &ALARM_CCITT_MTP32800,
    &ALARM_CCITT_MTP32801
