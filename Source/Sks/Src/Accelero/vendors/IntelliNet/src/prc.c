 ...
 ****************************************************************************
 *
 *  ID: $Id: prc.c,v 1.1.1.1 2007-10-08 11:12:16 bsccs2 Exp $
 *
...
#ident "$Id: prc.c,v 1.1.1.1 2007-10-08 11:12:16 bsccs2 Exp $"
...
ITSSS7DLLAPI VENDOR_ClassRec itsINTELLISS7_ClassRecPRC =
{
    ...
    /* vendor part */
    {
        ...
        /* ISUP */
        {
            ...
            INTELLINET_ReceiveISUPEvent_CCITT, /* retrieve */
            NULL,                           /* no send ANSI */
            INTELLINET_SendISUPEvent_CCITT, /* send event */
            INTELLINET_ISUP_Commit_CCITT
        },
        /* SCCP */
        {
