 ...
 ****************************************************************************
 *
 *  ID: $Id: its-ansi-sccp.c,v 1.1.1.1 2007-10-08 11:12:14 bsccs2 Exp $
 *
...
#ident "$Id: its-ansi-sccp.c,v 1.1.1.1 2007-10-08 11:12:14 bsccs2 Exp $"
...
SCCP_Console_ANSI(DBC_Server *dbc, const char *cmdLine)
{
...

    {
       ...
       if (ret != ITS_SUCCESS)
       {
        ...
        SCCP_Alarm_ANSI(500, __FILE__, __LINE__, "PC %08x, SSN %02d", pc, ssn);
        DBC_AppendText(dbc, buf);
    }
...

    {
        ...
        if (ret != ITS_SUCCESS)
        {
         ...
         SCCP_Alarm_ANSI(501, __FILE__, __LINE__, "PC %08x, SSN %02d", 
                          pc, ssn);
         DBC_AppendText(dbc, buf);
    }
                   ...
                   "<point code> <linkset>"))
    {
        ...
        SCCP_Alarm_ANSI(502, __FILE__, __LINE__, "PC %08x", pc);
        DBC_AppendText(dbc, buf);
...

    {
        ...
        SCCP_Alarm_ANSI(503, __FILE__, __LINE__, "PC %08x", pc);
        DBC_AppendText(dbc, buf);
...

    {
        ...
        SCCP_Alarm_ANSI(504, __FILE__, __LINE__, "PC %08x, SSN %02d", pc, ssn);
        DBC_AppendText(dbc, buf);
...

    {
        ...
        SCCP_Alarm_ANSI(505, __FILE__, __LINE__, "PC %08x, SSN %02d", pc, ssn);
        DBC_AppendText(dbc, buf);
...

    {
        ...
        SCCP_Alarm_ANSI(506, __FILE__, __LINE__, "PC %08x SSN %02d", pc, ssn);
        DBC_AppendText(dbc, buf);
...

    {
        ...
        SCCP_Alarm_ANSI(507, __FILE__, __LINE__, "PC %08x SSN %02d", pc, ssn);
        DBC_AppendText(dbc, buf);
