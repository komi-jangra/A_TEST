 ...
 ****************************************************************************
 *
 *  ID: $Id: ansi-mgmt.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $
 *
...
#ident "$Id: ansi-mgmt.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $"
 ...
 ****************************************************************************/
ITSSS7DLLAPI ITS_INT
MTP3_OSS_AddRemotePC_ANSI(ITS_UINT rpc, ITS_OCTET ni, ITS_OCTET linkSet, SS7_Family family)
{
    ITS_INT         ret;
    SS7_LinkSetPtr  ls;
    SS7_LinkPtr     lp;
 ...
 ****************************************************************************/
ITSSS7DLLAPI ITS_INT
MTP3_OSS_RemoveRemotePC_ANSI(ITS_UINT rpc, ITS_OCTET ni, ITS_OCTET linkSet, SS7_Family family)
{
    ITS_INT             ret;
    SS7_LinkSetPtr      ls;
    SS7_Destination     *rc;
