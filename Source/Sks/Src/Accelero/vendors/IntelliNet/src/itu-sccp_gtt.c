 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-sccp_gtt.c,v 1.1.1.1 2007-10-08 11:12:15 bsccs2 Exp $
 *
...
#ident "$Id: itu-sccp_gtt.c,v 1.1.1.1 2007-10-08 11:12:15 bsccs2 Exp $"
                        ...
                        ITS_SCCP_IE *ies, int ieCount)
{
    ...
    CALLBACK_CallCallbackListNoLock(SCCP_GlobalTitleTranslator,
                                               NULL, (void *)&data);
