 ...
 ****************************************************************************
 *
 *  ID: $Id: ttc-srm.c,v 1.1.1.1 2007-10-08 11:12:16 bsccs2 Exp $
 *
...
#ident "$Id: ttc-srm.c,v 1.1.1.1 2007-10-08 11:12:16 bsccs2 Exp $"
    ...
    case SRM_TRIGGER_TRANSFER_PROHIBIT:      /* from HMDT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            MTP3_ERROR(("%08x might think we're adjacent, but we don't.\n",
                         pc2));
            MTP3_Alarm_CCITT(2448, __FILE__, __LINE__, "%x",pc2); 
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_ALLOW:         /* from HMRT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            MTP3_Alarm_CCITT(2451, __FILE__, __LINE__, "%x",pc2);
        ...
        if (STPFunction_CCITT())
        {
            if (!SPRestarting_CCITT())
            {
                ...
                if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
                {
                    ...
                    MTP3_Alarm_CCITT(2456, __FILE__, __LINE__, "%x",pc2); 
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_RESTRICT:      /* from HMDT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            MTP3_Alarm_CCITT(2459, __FILE__, __LINE__, "%x",pc2);
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_CONTROL:       /* from HMDT */
        ...
        else
        {
            ...
            MTP3_Alarm_CCITT(2477, __FILE__, __LINE__,"dpc %x ni %x",pc1,ni);
        }
        break;
