 ...
 *                                                                          *
 ****************************************************************************
 *  ID: $Id: cpm2_mcc.h,v 1.1.1.1 2007-10-08 11:12:18 bsccs2 Exp $
 *
...
#define MCC_TSTATE_BE_BIG_END       (2U<<MCC_TSTATE_BE_SHIFT)
 ...
 */
#define MCC_IM_RSVD1_SHIFT 10
#define MCC_INTMASK_RESERVED1 (63<<MCC_IM_RSVD1_SHIFT)
...
#define MCC_IM_RSVD2_SHIFT 6
#define MCC_INTMASK_RESERVED2 (3U<<MCC_IM_RSVD2_SHIFT)
 ...
 */
#define MCC_CHAMR_POLL_SHIFT 14
#define MCC_CHARM_POLL_DISABLE   (0U<<MCC_CHAMR_POLL_SHIFT)
#define MCC_CHARM_POLL_ENABLE    (1U<<MCC_CHAMR_POLL_SHIFT)
...
#define MCC_CHAMR_RESET_HDLC     MCC_CHAMR_FIXED_BITS_GEN
#define MCC_CHAMR_RESET_TRAN     MCC_CHAMR_FIXED_BITS_TRA
...
#define MCCCHAMR_TS_OFF          (0U<<MCC_CHAMR_TS_SHIFT)
#define MCCCHAMR_TS_ON           (1U<<MCC_CHAMR_TS_SHIFT)
...
#define MCC_RSTATE_BE_BIG_END       (2U<<MCC_RSTATE_BE_SHIFT)
 ...
 */
#define MCC_ECHAMR_INT_OCT_SHIFT 29
#define MCC_EINTMASK_OCT             (1U<<MCC_ECHAMR_INT_OCT_SHIFT)

#define MCC_ECHAMR_INT_SUERM_SHIFT 28
#define MCC_EINTMASK_SUERM           (1U<<MCC_ECHAMR_INT_SUERM_SHIFT)

#define MCC_ECHAMR_INT_FISU_SHIFT 27
#define MCC_EINTMASK_FISU            (1U<<MCC_ECHAMR_INT_FISU_SHIFT)

#define MCC_ECHAMR_INT_UN_SHIFT 25
#define MCC_EINTMASK_UN              (1U<<MCC_ECHAMR_INT_UN_SHIFT)

#define MCC_ECHAMR_INT_TXB_SHIFT 24
#define MCC_EINTMASK_TXB             (1U<<MCC_ECHAMR_INT_TXB_SHIFT)

#define MCC_ECHAMR_INT_AERM_SHIFT 22
#define MCC_EINTMASK_AERM            (1U<<MCC_ECHAMR_INT_AERM_SHIFT)

#define MCC_ECHAMR_INT_NID_SHIFT 21
#define MCC_EINTMASK_NID             (1U<<MCC_ECHAMR_INT_NID_SHIFT)

#define MCC_ECHAMR_INT_IDL_SHIFT 20
#define MCC_EINTMASK_IDL             (1U<<MCC_ECHAMR_INT_IDL_SHIFT)

#define MCC_ECHAMR_INT_MRF_SHIFT 19
#define MCC_EINTMASK_MRF             (1U<<MCC_ECHAMR_INT_MRF_SHIFT)

#define MCC_ECHAMR_INT_RXF_SHIFT 18
#define MCC_EINTMASK_RXF             (1U<<MCC_ECHAMR_INT_RXF_SHIFT)

#define MCC_ECHAMR_INT_BSY_SHIFT 17
#define MCC_EINTMASK_BSY             (1U<<MCC_ECHAMR_INT_BSY_SHIFT)

#define MCC_ECHAMR_INT_RXB_SHIFT 16
#define MCC_EINTMASK_RXB             (1U<<MCC_ECHAMR_INT_RXB_SHIFT)

#define MCC_ECHAMR_POL_SHIFT 14
#define MCC_ECHAMR_POL_DISABLE       (0U<<MCC_ECHAMR_POL_SHIFT)
#define MCC_ECHAMR_POL_ENABLE        (1U<<MCC_ECHAMR_POL_SHIFT)

#define MCC_ECHAMR_IDLM_SHIFT 12
#define MCC_ECHAMR_IDLM_OFF          (0U<<MCC_ECHAMR_IDLM_SHIFT)
#define MCC_ECHAMR_IDLM_ON           (1U<<MCC_ECHAMR_IDLM_SHIFT)

#define MCC_ECHAMR_TS_SHIFT 5
#define MCC_ECHAMR_TS_OFF            (0U<<MCC_ECHAMR_TS_SHIFT)
#define MCC_ECHAMR_TS_ON             (1U<<MCC_ECHAMR_TS_SHIFT)

#define MCC_ECHAMR_RQN_SHIFT 3
#define MCC_ECHAMR_RQN_0             (0U<<MCC_ECHAMR_RQN_SHIFT)
#define MCC_ECHAMR_RQN_1             (1U<<MCC_ECHAMR_RQN_SHIFT)
#define MCC_ECHAMR_RQN_2             (2U<<MCC_ECHAMR_RQN_SHIFT)
#define MCC_ECHAMR_RQN_3             (3U<<MCC_ECHAMR_RQN_SHIFT)

#define MCC_ECHAMR_NOF_SHIFT 0
#define MCC_ECHAMR_NOF_1             (0U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_2             (1U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_3             (2U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_4             (3U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_5             (4U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_6             (5U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_7             (6U<<MCC_ECHAMR_NOF_SHIFT)
#define MCC_ECHAMR_NOF_8             (7U<<MCC_ECHAMR_NOF_SHIFT)
 ...
 */
#define MCCM_SET         (MCCE_RINT|MCCE_TINT|MCCE_RQOV0|MCCE_RQOV1|\
                          MCCE_RQOV2|MCCE_RQOV3|MCCE_TQOV|MCCE_GOV|MCCE_GUN)
/*
...
#define MCC_ICTE_UN    (1U<<10)  /* Underrun                      */
#define MCC_ICTE_RSVD1 (1U<<9)   /* Reserved                      */
...
#define MCC_TXBD_R           (1U<<15)  /* Ready:
                                        ...
                                        * 1=Buffer is ready for Tx. Don't write
                                        */
...
typedef void (*mcc_bd_proc_t)(int chan, mcc_channel_bd_t *);
...
typedef struct
{
    union
    {
        mcc_channel_specific_transparent_t *transparent;
        mcc_channel_specific_hdlc_t        *hdlc;
        mcc_channel_specific_ss7_t         *ss7;
    }
    type;
    mcc_channel_extra_param_t              *extra;
    mcc_channel_bd_t                       *rxbase;
    mcc_channel_bd_t                       *rx;
    mcc_channel_bd_t                       *txbase;
    mcc_channel_bd_t                       *tx;
    mcc_channel_stats_t                    *stats;
...
typedef struct
{
    ...
    u32                          txintcnt;
    u32                          rxintcnt;
    mcc_interrupt_table_entry_t  *txints;
    mcc_interrupt_table_entry_t  *rxints[4];
    mcc_interrupt_table_entry_t  *rxintbases[4];
