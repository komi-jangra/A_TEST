 ...
 ****************************************************************************
 *
 *  ID: $Id: ansi-srm.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $
 *
...
#ident "$Id: ansi-srm.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $"
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_PROHIBIT:      /* from HMDT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            MTP3_Alarm_ANSI(2448, __FILE__, __LINE__, "%x",pc2);
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_ALLOW:         /* from HMRT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            MTP3_Alarm_ANSI(2451, __FILE__, __LINE__, "%x",pc2);
            return (ITS_EINVALIDARGS);
        }
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_ROUTE_SET_TEST:         /* from HMDT */
        ...
        if (STPFunction_ANSI())
        {
		    ...
		    MTP3_Alarm_ANSI(2056, __FILE__, __LINE__, "%x",pc2);
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_RESTRICT:      /* from HMDT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            MTP3_Alarm_ANSI(2459, __FILE__, __LINE__, "%x",pc2);
    ...
    case SRM_TRIGGER_SEND_TRANSFER_RESTRICT: /* from RSRT: from TSRC */
        ...
        if ((ls = LINKSET_FindLinkSet(linkSet)) == NULL)
        {
            ...
            MTP3_Alarm_ANSI(2082, __FILE__, __LINE__, "LinkSet is %x", linkSet);
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SRM_TRIGGER_TRANSFER_CONTROL:       /* from HMDT */
        ...
        else
        {
            ...
            MTP3_Alarm_ANSI(2477, __FILE__, __LINE__, "dpc %08x ni %x",pc1,ni);
        }
        break;
