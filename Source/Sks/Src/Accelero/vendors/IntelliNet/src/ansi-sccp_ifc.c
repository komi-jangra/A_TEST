 ...
 ****************************************************************************
 *
 *  ID: $Id: ansi-sccp_ifc.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $
 *
...
#ident "$Id: ansi-sccp_ifc.c,v 1.1.1.1 2007-10-08 11:12:13 bsccs2 Exp $"
                              ...
                              SCCP_MSG_DESC* desc)
{
    ...
    if (!LICENSE_VerifyCapability(ITS_LIC_CAP_ANSI_SCCP))
    {
        ...
        SCCP_Alarm_ANSI(427, __FILE__, __LINE__, NULL);
                        ...
                        ITS_UINT pc, ITS_OCTET ssn)
{
    ...
    SCCP_Alarm_ANSI(428, __FILE__, __LINE__,
                    "PC %x SSN %d", pc, ssn);
                        ...
                        ITS_UINT pc, ITS_OCTET ssn)
{
    ...
    SCCP_Alarm_ANSI(429, __FILE__, __LINE__,
                    "PC %x SSN %d", pc, ssn);
                              ...
                              ITS_UINT pc, ITS_OCTET ssn, ITS_OCTET cong)
{
    ...
    SCCP_Alarm_ANSI(430, __FILE__, __LINE__,
                    "PC %x SSN %d", pc, ssn);
