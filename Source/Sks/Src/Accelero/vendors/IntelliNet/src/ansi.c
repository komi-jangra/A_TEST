 ...
 ****************************************************************************
 *
 *  ID: $Id: ansi.c,v 1.1.1.1 2007-10-08 11:12:14 bsccs2 Exp $
 *
...
#ident "$Id: ansi.c,v 1.1.1.1 2007-10-08 11:12:14 bsccs2 Exp $"
 ...
 * layer functions
 */
extern int IMTP2_Initialize_ANSI(ITS_SS7_HANDLE);
...
extern int IMTP2_Terminate_ANSI(ITS_SS7_HANDLE);
...
ITSSS7DLLAPI VENDOR_ClassRec itsINTELLISS7_ClassRecANSI =
{
    ...
    /* vendor part */
    {
        ...
        /* MTP2 */
        {
            IMTP2_Initialize_ANSI,                           /* no initialize */
            IMTP2_Terminate_ANSI,                           /* no terminate */
            NULL,                           /* no retrieve */
            NULL                            /* no send */
        },
        /* MTP3 */
