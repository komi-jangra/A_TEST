...
/******* Enter Preconfiguration Steps - END *******/
  ...
  do{
   ...
   if(!(oamsPsscmNsTestEnable.nsei == 1) )
   {
      flag = 0;
      fail("value of oamsPsscmNsTestEnable.nsei is not correct ");
      break;
   }
  }while(0);
...
/**************************************************************************
 ...
 TC Description: To see the transition when the message OAMS_CFG_PSSCM_LOCK_REQ is received in WaitForAutoConfigCnf state. Preconfiguration : { dbResult != CLIB_SUCCESS }
**************************************************************************/
START_TEST (TC_039)
{
int flag = 1;
...
int size = 0;
  ...
  /*Receive Message Struct */
   ...
   oamAfhAlarmInd.sysHdr.msgType = PSSKS_NS_PSSCM_ALARM_IND;
   oamAfhAlarmInd.sysHdr.subType = 0;
   oamAfhAlarmInd.sysHdr.priority = 0;
   oamAfhAlarmInd.sysAlarm.sysalarmId = EVENT_PSSKS_NS_MAX_TIMER_RETRIES_EXHAUSTED;
  ...
  oamAfhAlarmInd.sysAlarm.info3 = OAMS_OBJTYPE_BSSNODE;
...
int size = 0;
  ...
  /*Receive Message Struct */
   ...
   oamAfhAlarmInd.sysAlarm.alarmTime = 0;
   oamAfhAlarmInd.sysAlarm.alarmLevel = 0;
   oamAfhAlarmInd.sysAlarm.alarmReason = 0;
   oamAfhAlarmInd.sysAlarm.key1 = 0;
   oamAfhAlarmInd.sysAlarm.key2 = 0;
   oamAfhAlarmInd.sysAlarm.key3 = 0;
   oamAfhAlarmInd.sysAlarm.key4 = 0;
   oamAfhAlarmInd.sysAlarm.info1 = 0;
   oamAfhAlarmInd.sysAlarm.info2 = 0;
  oamAfhAlarmInd.sysAlarm.info3 = 0;
  oamAfhAlarmInd.sysAlarm.infoStrLen = 0;
  oamAfhAlarmInd.sysAlarm.infoString[150] = 0;
...
/******* Enter Verification Steps - END *******/
   ...
   if(0 == flag)
      test_result[57] = 2;    /* 2 for fail*/
   if(1 == flag)
      test_result[57] = 1;    /* 1 for pass*/
...
/******* Enter Preconfiguration Steps - END *******/
  ...
  do{
   ...
   if(!(oamsPsscmCfgUnlockResp.sysHdr.dest.clsId == 1) )
   {
      flag = 0;
...
int size = 0;
  ...
  /*Receive Message Struct */
   OamsPsscmCfgAlarmInd oamsPsscmCfgAlarmInd;
   OamsPsscmNsAutoConfig oamsPsscmNsAutoConfig;
   oamAfhAlarmInd.sysHdr.src.prcr = PRCR_CP;
   oamAfhAlarmInd.sysHdr.src.entity = ENT_PSSTK_GSAL;
   oamAfhAlarmInd.sysHdr.src.clsId = 0;
   oamAfhAlarmInd.sysHdr.src.rfu = 0;
   oamAfhAlarmInd.sysHdr.src.inst = 0;
...
//   PssksNsPsscmAlarmInd pssksNsPsscmAlarmInd;
  ...
  /*Receive Message Struct */
   ...
   oamAfhAlarmInd.sysAlarm.alarmTime = 0;
   oamAfhAlarmInd.sysAlarm.alarmLevel = 0;
   oamAfhAlarmInd.sysAlarm.alarmReason = 123;
   oamAfhAlarmInd.sysAlarm.key1 = 0;
   oamAfhAlarmInd.sysAlarm.key2 = 0;
   oamAfhAlarmInd.sysAlarm.key3 = 0;
   oamAfhAlarmInd.sysAlarm.key4 = 0;
...
/******* Enter Preconfiguration Steps - END *******/
  ...
  do{
   ...
   if(!(oamsPsscmBssgpProvPtpBvc.sysHdr.dest.clsId == GSAL_ACT_CLID_BSSGP) )
   {
      flag = 0;
      fail("value of oamsPsscmBssgpProvPtpBvc.sysHdr.dest.clsId is not correct ");
      break;
   }
   if(!(oamsPsscmBssgpProvPtpBvc.sysHdr.msgType == OAMS_PSSCM_BSSGP_PROV_PTP_BVC) )
   {
      flag = 0;
...
/******* Enter Preconfiguration Steps - END *******/
  ...
  do{
   ...
   {
      flag = 0;
      fail("value is %d", oamsPsscmNsUnprovPtpBvc.sysHdr.msgType);
      fail("value of oamsPsscmNsUnprovPtpBvc.sysHdr.msgType is not correct ");
      break;
   }
   if(!(oamsPsscmNsUnprovPtpBvc.apiId == OAM_NS_UNPROV_BVCI) )
