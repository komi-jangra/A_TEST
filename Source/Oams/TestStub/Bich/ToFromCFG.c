...
fprintf(stderr, "-------->>13.To Send OAMS_CFG_BICH_LOCK_REQ \n");
fprintf(stderr, "-------->>14.To Send OAMS_CFG_BICH_UNLOCK_REQ \n");
fprintf(stderr, "-------->>15.To Send OAMS_CFG_BICH_ADD_TRX_INDICATION \n");
fprintf(stderr, "-------->>16.To Send OAMS_CFG_BICH_DEL_TRX_INDICATION \n");
fprintf(stderr, "-------->>17 To Send OAMS_CFG_BICH_BTS_RESET \n");
fprintf(stderr, "<<--------18. To_Receive data \n");
...
//		printf("\n----Value of CellId and Lac is - %d %d\n", cellId,lac); 
  ...
  case 3 :
	...
	if (choice ==1  || choice == 2 ||  choice == 3 || choice == 4 || choice ==5 \
            || choice == 6 || choice == 7 || choice == 8 || choice == 9 || choice == 10 || choice == 11 || choice == 12 || choice == 13 || choice == 14 || choice == 15 || choice == 16 || choice == 17 )
	{
